    ...
    <div class="container-fluid px-4">
        <div class="mb-1 hstack gap-2">
            ...
            <ol class="breadcrumb mb-3 mt-3 ms-auto">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('classe.index', ['course' => $course->id]) }}" class="text-decoration-none">Curso</a>
                </li>
            ...
            <div class="card-body">
                ...
                <form class="row g-3"  action="{{ route('classe.store') }}" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text"  name="name_course" id="name_course" class="form-control" value="{{ $course->name }}" disabled>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea type="text"  name="description" id="description" class="form-control" placeholder="descrição da aula" required>{{ old('description') }}</textarea>
                    </div>
