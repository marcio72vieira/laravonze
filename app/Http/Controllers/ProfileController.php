...
class ProfileController extends Controller
{
    ...
    // Editar no banco de dados o perfil do usuário logado
    ...
    {
        // Implementando a validação dentro do próprio método, por isso utiiza-se o Request $request acima
        // Validar o formulário
        $request->validate([
        ...
        try {
            ...
            // Redirecionar o usuário, enviar a mensagem de sucesso
            return redirect()->route('profile.show')->with('success', 'Senha do pefil editada com sucesso!');
        } catch (Exception $e) {
